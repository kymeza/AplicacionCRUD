...
namespace AplicacionCRUD
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(sistemaUsuariosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CodigoUsuario,Email,Password,Nombre,Apellido")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CodigoUsuario,Email,Password,Nombre,Apellido")] Usuario usuario)
        {
